...
#ifndef DS1_FILE_LIB_RAGDOLL_PARAM_DEF_FILE_H_
    #define DS1_FILE_LIB_RAGDOLL_PARAM_DEF_FILE_H_
...
// Ragdoll parameter data manipulation class
...
#endif // DS1_FILE_LIB_RAGDOLL_PARAM_DEF_FILE_H_
