/*
    ...
    Attack Parameters from AtkParam_Npc.paramdef
...
#pragma once
    ...
    #define DS1_FILE_LIB_NPC_ATTACK_PARAM_DEF_FILE_H_
...
public:
    ...
    {
        static AttackNpcParamDef instance;
        return instance;
    }

    AttackNpcParam *data()
    {
        return (AttackNpcParam*)ParamDef::data();
    }

    AttackNpcParam *get(int index)
    {
        return (AttackNpcParam*)ParamDef::get(index);
    }
