/*
	...
	GameFiles/ParamDef/NpcThinkParamDef.h
...
#ifndef _DS1_OVERHAUL_NPC_THINK_PARAM_DEF_FILE_H_
	#define _DS1_OVERHAUL_NPC_THINK_PARAM_DEF_FILE_H_
...
class NpcThinkParamDef : public GameParamDef {
...
public:
	...
	NpcThinkParam *data()
	{
		return (NpcThinkParam*)GameParamDef::data();
	}

	NpcThinkParam *get(int index)
	{
		return (NpcThinkParam*)GameParamDef::get(index);
	}
...
#endif // _DS1_OVERHAUL_NPC_THINK_PARAM_DEF_FILE_H_
