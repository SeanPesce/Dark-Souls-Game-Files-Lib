/*
	...
	GameFiles/ParamDef/WeaponParamDef.h
...
#ifndef _DS1_OVERHAUL_WEAPON_PARAM_DEF_FILE_H_
	#define _DS1_OVERHAUL_WEAPON_PARAM_DEF_FILE_H_
...
class WeaponParamDef : public GameParamDef {
...
public:
	...
	WeaponParam *data()
	{
		return (WeaponParam*)GameParamDef::data();
	}

	WeaponParam *get(int index)
	{
		return (WeaponParam*)GameParamDef::get(index);
	}
...
#endif // _DS1_OVERHAUL_WEAPON_PARAM_DEF_FILE_H_
