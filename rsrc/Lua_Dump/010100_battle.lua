...
DS2pot10100_Battle_Sword = function(ai, goal)
   ...
   if func3_var3 <= func3_var2 then
      if func3_var4 <= 50 then
         goal:AddSubGoal(GOAL_COMMON_ApproachTarget, 5, TARGET_ENE_0, func3_var3, TARGET_ENE_0, false, 4)
         DS2pot10100_Battle_Kougeki_Noato(ai, goal)
      else
         goal:AddSubGoal(GOAL_COMMON_ApproachTarget, 5, TARGET_ENE_0, func3_var3, TARGET_ENE_0, false, -1)
         DS2pot10100_Battle_Kougeki_Noato(ai, goal)
      end
   else
