...
local localScriptConfigVar3 = 1.2
...
local localScriptConfigVar15 = 1.5
local localScriptConfigVar16 = 3.5
local localScriptConfigVar17 = 4.5
DragonOracle6370Battle_Activate = function(ai, goal)
   ...
   if func1_var7 >= 8 then
      func1_var2[1] = 15
      func1_var2[2] = 10000 * func1_var8 * func1_var15
      func1_var2[3] = 15
      func1_var2[4] = 0
      func1_var2[5] = 0
      func1_var2[6] = 60
      func1_var2[7] = 0
      func1_var2[8] = 50 * func1_var10
      func1_var2[9] = 10 * func1_var12
   ...
   func1_var3[1] = REGIST_FUNC(ai, goal, DragonOracle6370_Act01)
   func1_var3[2] = REGIST_FUNC(ai, goal, DragonOracle6370_Act02)
   func1_var3[3] = REGIST_FUNC(ai, goal, DragonOracle6370_Act03)
   func1_var3[4] = REGIST_FUNC(ai, goal, DragonOracle6370_Act04)
   func1_var3[5] = REGIST_FUNC(ai, goal, DragonOracle6370_Act05)
   func1_var3[6] = REGIST_FUNC(ai, goal, DragonOracle6370_Act06)
   func1_var3[7] = REGIST_FUNC(ai, goal, DragonOracle6370_Act07)
   func1_var3[8] = REGIST_FUNC(ai, goal, DragonOracle6370_Act08)
   func1_var3[9] = REGIST_FUNC(ai, goal, DragonOracle6370_Act09)
   local func1_var16 = REGIST_FUNC(ai, goal, DragonOracle6370_ActAfter_AdjustSpace, atkAfterOddsTbl)
   Common_Battle_Activate(ai, goal, func1_var2, func1_var3, func1_var16, func1_var4)
end

DragonOracle6370_Act01 = function(ai, goal, func2_param2)
...
DragonOracle6370_Act02 = function(ai, goal, func3_param2)
   local func3_var3 = ai:GetDist(TARGET_ENE_0)
   local func3_var4 = ai:GetRandam_Int(1, 100)
   local func3_var5 = ai:GetWepCateRight(TARGET_SELF)
   local func3_var6 = ai:GetNumber(0)
   CommonNPC_ChangeWepR2(ai, goal)
   ai:ChangeEquipMagic(0)
   if localScriptConfigVar7 <= func3_var3 then
      goal:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, NPC_ATK_MagicR, TARGET_ENE_0, DIST_None, 0, -1)
   else
      goal:AddSubGoal(GOAL_COMMON_LeaveTarget, 7, TARGET_ENE_0, localScriptConfigVar6, TARGET_ENE_0, false, 4)
      goal:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, NPC_ATK_MagicR, TARGET_ENE_0, DIST_None, 0, -1)
   end
   ai:SetNumber(0, func3_var6 + 1)
   GetWellSpace_Odds = 0
   return GetWellSpace_Odds
end

DragonOracle6370_Act03 = function(ai, goal, func4_param2)
...
DragonOracle6370_Act04 = function(ai, goal, func5_param2)
...
DragonOracle6370_Act05 = function(ai, goal, func6_param2)
...
DragonOracle6370_Act06 = function(ai, goal, func7_param2)
   local func7_var3 = ai:GetDist(TARGET_ENE_0)
   local func7_var4 = ai:GetRandam_Int(1, 100)
   local func7_var5 = localScriptConfigVar17
   local func7_var6 = localScriptConfigVar17 + 5
...
DragonOracle6370_Act07 = function(ai, goal, func8_param2)
...
DragonOracle6370_Act08 = function(ai, goal, func9_param2)
...
DragonOracle6370_Act09 = function(ai, goal, func10_param2)
...
DragonOracle6370_ActAfter_AdjustSpace = function(ai, goal, func11_param2)
