...
Frustrated_FighterH6271Battle_Activate = function(ai, goal)
   ...
   -- Tried to add an 'end' here but it's incorrect
   func1_var3[1] = REGIST_FUNC(ai, goal, Frustrated_FighterH6271_Act01)
   func1_var3[2] = REGIST_FUNC(ai, goal, Frustrated_FighterH6271_Act02)
   func1_var3[3] = REGIST_FUNC(ai, goal, Frustrated_FighterH6271_Act03)
   func1_var3[4] = REGIST_FUNC(ai, goal, Frustrated_FighterH6271_Act04)
   func1_var3[5] = REGIST_FUNC(ai, goal, Frustrated_FighterH6271_Act05)
   func1_var3[6] = REGIST_FUNC(ai, goal, Frustrated_FighterH6271_Act06)
   func1_var3[7] = REGIST_FUNC(ai, goal, Frustrated_FighterH6271_Act07)
   func1_var3[8] = REGIST_FUNC(ai, goal, Frustrated_FighterH6271_Act08)
   local func1_var8 = REGIST_FUNC(ai, goal, Frustrated_FighterH6271_ActAfter_AdjustSpace, atkAfterOddsTbl)
   Common_Battle_Activate(ai, goal, func1_var2, func1_var3, func1_var8, func1_var4)
end

Frustrated_FighterH6271_Act01 = function(ai, goal, func2_param2)
...
Frustrated_FighterH6271_Act02 = function(ai, goal, func3_param2)
...
Frustrated_FighterH6271_Act03 = function(ai, goal, func4_param2)
...
Frustrated_FighterH6271_Act04 = function(ai, goal, func5_param2)
...
Frustrated_FighterH6271_Act05 = function(ai, goal, func6_param2)
...
Frustrated_FighterH6271_Act06 = function(ai, goal, func7_param2)
...
Frustrated_FighterH6271_Act07 = function(ai, goal, func8_param2)
...
Frustrated_FighterH6271_Act08 = function(ai, goal, func9_param2)
...
Frustrated_FighterH6271_ActAfter_AdjustSpace = function(ai, goal, func10_param2)
