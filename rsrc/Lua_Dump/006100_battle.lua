...
local localScriptConfigVar17 = 1.7
Knight_of_HolyWomanC6100Battle_Activate = function(ai, goal)
   ...
   if func1_var12 >= 5 or ai:IsFinishTimer(0) ~= true then
      func1_var11 = 0
   end
   local func1_var13 = 0
   ...
   if func1_var8 >= 4 then
      func1_var2[1] = 35
      func1_var2[2] = 35
      func1_var2[9] = 35 * func1_var13 * func1_var9
      func1_var2[10] = 35 * func1_var13 * func1_var9
      func1_var2[18] = 10000 * func1_var11 * func1_var15
      func1_var2[20] = 30
   elseif func1_var8 >= 2.1 then
      func1_var2[1] = 20
      func1_var2[2] = 20
      func1_var2[9] = 20 * func1_var13 * func1_var9
      func1_var2[10] = 20 * func1_var13 * func1_var9
      func1_var2[17] = 20 * func1_var13
      func1_var2[18] = 10000 * func1_var11 * func1_var15
      func1_var2[20] = 35
   else
      func1_var2[1] = 20
   ...
   func1_var3[1] = REGIST_FUNC(ai, goal, Knight_of_HolyWomanC6100_Act01)
   func1_var3[2] = REGIST_FUNC(ai, goal, Knight_of_HolyWomanC6100_Act02)
   func1_var3[9] = REGIST_FUNC(ai, goal, Knight_of_HolyWomanC6100_Act09)
   func1_var3[10] = REGIST_FUNC(ai, goal, Knight_of_HolyWomanC6100_Act10)
   func1_var3[11] = REGIST_FUNC(ai, goal, Knight_of_HolyWomanC6100_Act11)
   func1_var3[17] = REGIST_FUNC(ai, goal, Knight_of_HolyWomanC6100_Act17)
   func1_var3[18] = REGIST_FUNC(ai, goal, Knight_of_HolyWomanC6100_Act18)
   func1_var3[20] = REGIST_FUNC(ai, goal, Knight_of_HolyWomanC6100_Act20)
   local func1_var16 = REGIST_FUNC(ai, goal, Knight_of_HolyWomanC6100_ActAfter_AdjustSpace, atkAfterOddsTbl)
   Common_Battle_Activate(ai, goal, func1_var2, func1_var3, func1_var16, func1_var4)
end

Knight_of_HolyWomanC6100_Act01 = function(ai, goal, func2_param2)
...
Knight_of_HolyWomanC6100_Act02 = function(ai, goal, func3_param2)
...
Knight_of_HolyWomanC6100_Act09 = function(ai, goal, func4_param2)
...
Knight_of_HolyWomanC6100_Act10 = function(ai, goal, func5_param2)
...
Knight_of_HolyWomanC6100_Act17 = function(ai, goal, func6_param2)
...
Knight_of_HolyWomanC6100_Act18 = function(ai, goal, func7_param2)
...
Knight_of_HolyWomanC6100_Act20 = function(ai, goal, func8_param2)
...
Knight_of_HolyWomanC6100_ActAfter_AdjustSpace = function(ai, goal, func9_param2)
