...
local localScriptConfigVar3 = 0.6
local localScriptConfigVar4 = 4
local localScriptConfigVar5 = 5
mukadesippo520200Battle_Activate = function(ai, goal)
   local func1_var2 = {}
   local func1_var3 = {}
   local func1_var4 = {}
   Common_Clear_Param(func1_var2, func1_var3, func1_var4)
   local func1_var5 = ai:GetDist(TARGET_ENE_0)
   if func1_var5 >= 4 then
      func1_var2[1] = 0
      func1_var2[3] = 0
      func1_var2[4] = 100
   else
   ...
   func1_var6 = func1_var6(ai, goal, MukadeSippo520200_Act04)
   func1_var3[4] = func1_var6
   func1_var6 = REGIST_FUNC
   func1_var6 = func1_var6(ai, goal, MukadeSippo520200_ActAfter_AdjustSpace, atkAfterOddsTbl)
   Common_Battle_Activate(ai, goal, func1_var2, func1_var3, func1_var6, func1_var4)
end

MukadeSippo520200_Act04 = function(ai, goal, func2_param2)
...
MukadeSippo520200_ActAfter_AdjustSpace = function(ai, goal, func3_param2)
...
mukadesippo520200Battle_Update = function(ai, goal)
   return GOAL_RESULT_Continue
end

mukadesippo520200Battle_Terminate = function(ai, goal)
end

mukadesippo520200Battle_Interupt = function(ai, goal)
