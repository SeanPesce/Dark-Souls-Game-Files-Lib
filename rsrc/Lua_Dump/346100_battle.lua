...
ArmoredTask_BackGuard346100Battle_Activate = function(ai, goal)
   ...
   local func1_var19 = ai:GetDistAtoB(POINT_EVENT, TARGET_SELF)
   if ai:IsInsideTargetRegion(TARGET_ENE_0, 1702750) or ai:IsInsideTargetRegion(TARGET_ENE_0, 1702752) then
      func1_var18 = 100
   elseif ai:IsFinishTimer(0) == true and func1_var2 >= 12 then
      ai:SetTimer(0, func1_var3)
      func1_var13 = 100
   elseif func1_var2 <= 1.1 and func1_var5 <= 80 and ai:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_B, 45) then
      func1_var16 = 100
   elseif func1_var2 <= 2 and func1_var5 <= 80 and ai:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_L, 90) then
      func1_var14 = 100
   elseif func1_var2 <= 2 and func1_var5 <= 80 and ai:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_R, 90) then
      func1_var15 = 100
   ...
   local func1_var20 = ai:GetRandam_Int(1, func1_var10 + func1_var11 + func1_var12 + func1_var13 + func1_var14 + func1_var15 + func1_var16 + func1_var17 + func1_var18)
