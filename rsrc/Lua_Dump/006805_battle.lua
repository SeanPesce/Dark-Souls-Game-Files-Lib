...
BanditE6805Battle_Activate = function(ai, goal)
   ...
   local func1_var15 = 0
   if func1_var14 <= 0.7 or ai:ChkNearLowHpFriend(0.7, 2.9) then
      func1_var15 = 1
   end
   if func1_var8 >= 4 then
      func1_var2[1] = 35
      func1_var2[2] = 35
      func1_var2[18] = 1000 * func1_var11 * func1_var15
      func1_var2[19] = 50 * func1_var13
      func1_var2[20] = 30
   ...
   func1_var3[1] = REGIST_FUNC(ai, goal, BanditE6805_Act01)
   func1_var3[2] = REGIST_FUNC(ai, goal, BanditE6805_Act02)
   func1_var3[5] = REGIST_FUNC(ai, goal, BanditE6805_Act05)
   func1_var3[17] = REGIST_FUNC(ai, goal, BanditE6805_Act17)
   func1_var3[18] = REGIST_FUNC(ai, goal, BanditE6805_Act18)
   func1_var3[19] = REGIST_FUNC(ai, goal, BanditE6805_Act19)
   func1_var3[20] = REGIST_FUNC(ai, goal, BanditE6805_Act20)
   local func1_var16 = REGIST_FUNC(ai, goal, BanditE6805_ActAfter_AdjustSpace, atkAfterOddsTbl)
   Common_Battle_Activate(ai, goal, func1_var2, func1_var3, func1_var16, func1_var4)
end

BanditE6805_Act01 = function(ai, goal, func2_param2)
...
BanditE6805_Act02 = function(ai, goal, func3_param2)
...
BanditE6805_Act05 = function(ai, goal, func4_param2)
...
BanditE6805_Act17 = function(ai, goal, func5_param2)
...
BanditE6805_Act19 = function(ai, goal, func7_param2)
...
BanditE6805_Act20 = function(ai, goal, func8_param2)
...
BanditE6805_ActAfter_AdjustSpace = function(ai, goal, func9_param2)
