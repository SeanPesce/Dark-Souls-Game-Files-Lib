...
DarkMoon_Juu6640Battle_Activate = function(ai, goal)
   ...
   func1_var3[1] = REGIST_FUNC(ai, goal, DarkMoon_Juu6640_Act01)
   func1_var3[2] = REGIST_FUNC(ai, goal, DarkMoon_Juu6640_Act02)
   func1_var3[5] = REGIST_FUNC(ai, goal, DarkMoon_Juu6640_Act05)
   func1_var3[9] = REGIST_FUNC(ai, goal, DarkMoon_Juu6640_Act09)
   func1_var3[10] = REGIST_FUNC(ai, goal, DarkMoon_Juu6640_Act10)
   func1_var3[13] = REGIST_FUNC(ai, goal, DarkMoon_Juu6640_Act13)
   func1_var3[17] = REGIST_FUNC(ai, goal, DarkMoon_Juu6640_Act17)
   func1_var3[20] = REGIST_FUNC(ai, goal, DarkMoon_Juu6640_Act20)
   local func1_var11 = REGIST_FUNC(ai, goal, DarkMoon_Juu6640_ActAfter_AdjustSpace, atkAfterOddsTbl)
   Common_Battle_Activate(ai, goal, func1_var2, func1_var3, func1_var11, func1_var4)
end

DarkMoon_Juu6640_Act01 = function(ai, goal, func2_param2)
...
DarkMoon_Juu6640_Act02 = function(ai, goal, func3_param2)
...
DarkMoon_Juu6640_Act05 = function(ai, goal, func4_param2)
...
DarkMoon_Juu6640_Act09 = function(ai, goal, func5_param2)
...
DarkMoon_Juu6640_Act10 = function(ai, goal, func6_param2)
   local func6_var3 = ai:GetDist(TARGET_ENE_0)
   local func6_var4 = ai:GetRandam_Int(1, 100)
   CommonNPC_ChangeWepR1(ai, goal)
   NPC_RYOUTE_Switch(ai, goal)
   local func6_var5 = localScriptConfigVar7
   local func6_var6 = localScriptConfigVar7 + 5
...
DarkMoon_Juu6640_Act13 = function(ai, goal, func7_param2)
...
DarkMoon_Juu6640_Act17 = function(ai, goal, func8_param2)
...
DarkMoon_Juu6640_Act20 = function(ai, goal, func9_param2)
...
DarkMoon_Juu6640_ActAfter_AdjustSpace = function(ai, goal, func10_param2)
   local func10_var3 = ai:GetRandam_Int(1, 100)
   local func10_var4 = ai:GetRandam_Int(1, 100)
   local func10_var5 = 3
   if func10_var3 <= 100 then
...
DarkMoon_Juu6640Battle_Interupt = function(ai, goal)
   ...
   if ai:IsInterupt(INTERUPT_Damaged) then
      ...
      if func13_var2 < func13_var6 and func13_var3 <= func13_var7 then
         goal:ClearSubGoal()
         if func13_var3 <= 50 then
            goal:AddSubGoal(GOAL_COMMON_LeaveTarget, ai:GetRandam_Int(3, 5), TARGET_ENE_0, func13_var6, TARGET_ENE_0, true, 4)
         else
            goal:AddSubGoal(GOAL_COMMON_SidewayMove, ai:GetRandam_Float(3, 4), TARGET_ENE_0, ai:GetRandam_Int(0, 1), ai:GetRandam_Float(30, 50), true, true, 4)
         end
         return true
   ...
   if ai:IsInterupt(INTERUPT_Shoot) then
      ...
      if func13_var3 <= func13_var6 then
         goal:ClearSubGoal()
         local func13_var7 = localScriptConfigVar3
         local func13_var8 = localScriptConfigVar3 + 5
         local func13_var9 = 100
         NPC_Approach_Act(ai, goal, func13_var7, func13_var8, func13_var9)
         goal:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, NPC_ATK_LargeR, TARGET_ENE_0, DIST_Middle, 1.5, 90)
         return true
      end
   end
